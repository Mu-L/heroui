...
补丁版本：[Tooltip](/docs/components/tooltip) 新增 `--tooltip-delay` 与 `--tooltip-close-delay` 主题变量，用于全局配置显示与隐藏延迟。单个 Tooltip 上的 `delay` 和 `closeDelay` 属性仍会覆盖这些值。

[阅读完整发布说明 →](/docs/react/releases/v3-1-1)
