...
Patch release: [Tooltip](/docs/components/tooltip) adds `--tooltip-delay` and `--tooltip-close-delay` theme variables for global show and hide timing. Individual `delay` and `closeDelay` props still override these values.

[Read full release notes →](/docs/react/releases/v3-1-1)
